...
public class WorkQueue {
	...
	/** The number of pending tasks still left. */
	private int pending;

	/** Lock object for task queue synchronization. */
	...
	/**
	 * Decrements the pending task count in a thread-safe manner and notifies
	 * waiting threads if pending reaches zero.
	 */
